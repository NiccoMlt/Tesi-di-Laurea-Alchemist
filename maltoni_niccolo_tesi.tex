...
\usepackage[utf8]{inputenc}     % serve per impostare la codifica di input del font come UTF8
\usepackage[
...
\usepackage{lmodern}            % carica un variante Latin Modern prodotto dal GUST, necessario per risolvere un errore col font
...
% hyperref deve essere generalmente l'ultimo pacchetto
\usepackage[%
...
\begin{document}
    ...
    \input{tex/mainmatter/appendice.tex}
