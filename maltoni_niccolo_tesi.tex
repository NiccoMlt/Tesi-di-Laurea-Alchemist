...
% arara: pdflatex: { shell: true, synctex: yes, action: batchmode, options: "-halt-on-error -file-line-error-style" }
% arara: frontespizio
% arara: biber
% arara: pdflatex: { shell: true, synctex: yes, action: batchmode, options: "-halt-on-error -file-line-error-style" }
% arara: pdflatex: { shell: true, synctex: yes, action: nonstopmode, options: "-halt-on-error -file-line-error-style" }
...
% https://tex.stackexchange.com/a/136653
% \pdfminorversion 4
% \immediate\pdfobj stream attr{/N 3}  file{eciRGB/eciRGB_v2.icc}
% \pdfcatalog{%
% /OutputIntents [ <<
% /Type /OutputIntent
% /S/GTS_PDFA1
...
%% Configurazioni orribili, ma funzionano %%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\hypersetup{%
    ...
    pdflang={it},
    pdfsubject={Subject},
    pdfkeywords={Simulazione, JavaFX, Interfaccia grafica},
    pdfa
}
