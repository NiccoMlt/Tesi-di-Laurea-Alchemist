    ...
    \section{Fonti d'ispirazione}\label{sec:ispirazione}
        ...
        \subsection{Simulatori a scopo videoludico}\label{sub:videogame}
            ...
            \subsubsection{SimCity}\label{subsub:simcity}
                ...
                % TODO lo screenshot serve?

                % TODO potrebbe essere utile inserire ulteriori dettagli?

            \subsubsection{Universe Sandbox}\label{subsub:us1}
                Altra serie di videogiochi simulativi analizzata è Universe Sandbox, composta dall'omonimo primo capitolo, rilasciato nel 2008, e Universe Sandbox\ap{2} del 2015.
