...
\chapter{Contributo}\label{ch:contributo}
    ...
    \section{Progettazione}\label{sec:progettazione}
        ...
        \subsection{La struttura dei drawer e le proprietà osservabili}\label{sub:drawer}
            ...
            Trascurando i dettagli implementativi prettamente legati all'implementazione grafica, di cui si parla nella Sezione~\vref{sec:dettagli}, è stato importante progettare la gestione degli eventi di modifica di proprietà di effetti e gruppi.
            Come detto nella Sottosezione~\vref{itm:eFXobservable}, si è deciso di fare ampio uso del pattern \engEmph{Observer}, ciascun effetto è progettato per implementare proprietà osservabili (UML in \figurename~\vref{fig:props}), che possono implementare ascoltatori di eventi dedicati in modo semplice, potendosi avvalere delle API messe a disposizione dal framework JavaFX.
