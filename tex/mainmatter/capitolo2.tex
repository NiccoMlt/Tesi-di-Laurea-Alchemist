...
\chapter{Contributo}\label{ch:contributo}
    ...
    \section{Progettazione}\label{sec:progettazione}
        ...
        \subsection{L'architettura degli effetti}\label{sub:effetti}
            ...
            Come rapprsentato graficamente nel diagramma UML in \figurename~\vref{fig:effectFX}, la struttura di funzionamento di base viene parzialmente concretizzata da una classe astratta
