        ...
        \subsection{L'architettura degli effetti}\label{sub:effetti}
            ...
            Infatti, concettualmente il nuovo archetipo di effetti (della cui interfaccia è possibile vedere il codice in Appendice~\ref{appendix:effectfx}) rappresenta un oggetto completamente diverso:
                \begin{itemize}
                    ...
                    \item[--] le proprietà peculiari di ciascun effetto sono pensate per implementare il pattern observable, permettendo di effettuare collegamenti con l'interfaccia in modo trasparente ed ottimizzato, in quanto gestito completamente dal framework di JavaFX.
