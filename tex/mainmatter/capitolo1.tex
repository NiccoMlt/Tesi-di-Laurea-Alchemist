    ...
    \section{JavaFX}\label{sec:jfx}
        ...
        \subsection{Vantaggi di JavaFX su Swing}\label{sub:jfxVantaggi}
            ...
            \begin{description}
              ...
              \item[Skin e CSS] Altro miglioramento in merito alla flessibilità riguarda il supporto ai fogli di stile CSS (\engEmph{Cascading style sheet}): ampiamente utilizzati nello sviluppo web, esi permettono di sviluppare temi per una applicazione JavaFX senza coinvolgere il codice Java, a differenza dei \engEmph{look'n'feel} di Swing, né i file FXML, incapsulando completamente la componente di presentazione.
