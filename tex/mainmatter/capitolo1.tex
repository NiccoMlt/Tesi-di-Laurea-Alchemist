...
\chapter{Introduzione}\label{ch:intro}
    ...
    \section{Alchemist}\label{sec:alchemist}
        ...
        % \subsection{Architettura di Alchemist}\label{sub:architettura} % TODO
        ...
        \subsection{Astrazioni e modello di Alchemist}\label{sub:modello}
            ...
            Le entità (visibile in \figurename~\cref{fig:model}) su cui lavora sono le seguenti:
            ...
            \begin{description}
                ...
                \item[\engEmph{Reaction}\label{itm:react}]
                    ...
                    Una \emph{Reazione} (di cui è possibile vederne una rappresentazione grafica in \figurename~\cref{fig:react}) è dunque un qualsiasi evento che può cambiare lo stato dell’\emph{Ambiente} e si compone di un insieme di condizioni, una o più azioni e una distribuzione temporale.
        ...
        \subsection{Interfaccia utente classica}\label{sub:prevGui}
            ...
            \subsubsection{Esperienza utente}\label{subsub:prevUx}
                ...
                Un'ultima criticità che esula dal contesto pratico, ma che rientra appieno nel contesto estetico importante per una buona UX è, appunto l'aspetto grafico: l'intera interfaccia di simulazione è implementata sfruttando le impostazioni di base del framework Swing, senza alcun tipo di personalizzazione al \engEmph{look'n'feel} che potesse identificare uno stile originale di Alchemist, né che lo allineasse alle direttive di un design grafico ben definito (come il Material Design~\cite{material} di Google o Modern UI e Fluent Design System~\cite{fluent} di Microsoft), né che si adattasse al \engEmph{look'n'feel} generico del sistema operativo.
            ...
            \subsubsection{Swing}\label{subsub:swing}
                ...
                Come è possibile vedere in \figurename~\cref{fig:awt}, la libreria sfrutta i componenti forniti da AWT, mettendo a disposizione nuovi componenti in grado di risolvere diverse debolezze del precedente standard grafico per il linguaggio di Oracle:
    ...
    \section{JavaFX}\label{sec:jfx}
        ...
        \subsection{Architettura del framework JavaFX}\label{sub:jfxFramework}
            Come è possibile osservare in \figurename~\cref{fig:jfxArch}, l'architettura interna di JavaFX è costituita da diversi livelli, ciascuno dei quali sfrutta le funzionalità messe a disposizione dai livelli inferiori per offrire nuove API ai livelli superiori e allo sviluppatore finale.
        ...
        \subsection{Struttura di una Applicazione JavaFX}\label{sub:jfxStruttura}
            ...
            Il layout con cui un'applicazione JavaFX è costituita a livello grafico si struttura gerarchicamente su tre sezioni principali, visibili in \figurename~\cref{fig:jfxStage}:
            ...
            \end{figure}
                ...
                In \figurename~\cref{fig:jfxNode} è possibile vedere una rappresentazione gerarchica delle diverse tipologie di \emph{nodo}.
            \end{description}
        ...
        \subsection{Vantaggi di JavaFX su Swing}\label{sub:jfxVantaggi}
            ...
            \begin{description}
              ...
              Da non sottovalutare è anche la presenza di un software ufficiale per il design dell'interfaccia in FXML: \engEmph{Scene Builder}. Esso offre un'interfaccia \engEmph{drag'n'drop} per l'aggiunta dei componenti grafici, ed è perfettamente integrato in tutte le IDE più utilizzate (Eclipse, Intellij IDEA, Netbeans).
              ...
              \item[Skin e CSS] Altro miglioramento in merito alla flessibilità riguarda il supporto ai fogli di stile CSS (\engEmph{Cascading style sheet}): ampiamente utilizzati nello sviluppo web, essi permettono di sviluppare temi per una applicazione JavaFX senza coinvolgere il codice Java, a differenza dei \engEmph{look'n'feel} di Swing, né i file FXML, incapsulando completamente la componente di presentazione.

              \item[Supporto multimediale] Grazie a JavaFX Media, la piattaforma supporta nativamente i più comuni formati audio (MP3, AIFF, WAV, AAC) e video (FLV con compressione VP6, MP4 con compressione H.264/AVC) senza richiedere l'utilizzo di librerie interne. Il supporto è incluso anche nella \engEmph{Webview}.
    ...
    \section{Interfaccia JavaFX per Alchemist: motivazioni}\label{sec:motivi}
        Come spiegato nella sottosezione~\cref{subsub:prevUx}, l'esperienza utente dell'interfaccia utente classica di Alchemist è estremamente limitata.
