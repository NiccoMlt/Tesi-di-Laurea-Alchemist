    ...
    \section{Introduzione}\label{sec:intro}
        \subsection{Obiettivo}\label{subsec:obiettivo}
            \begin{frame}
                ...
                \medskip
                \pause
                La nuova interfaccia permette di interagire con la simulazione a tempo di esecuzione e di vedere rappresentate informazioni su di essa attraverso un'interfaccia il più possibile \engEmph{user-friendly}.
            \end{frame}
    ...
    \section{L'interfaccia implementata}\label{sec:newgui}
        \subsection{Caratteristiche}\label{subsec:feature}
            \begin{frame}
                \frametitle{\insertsection}
                \framesubtitle{\insertsubsection}
                \centering \huge TODO % TODO inserisci screenshot
            \end{frame}
